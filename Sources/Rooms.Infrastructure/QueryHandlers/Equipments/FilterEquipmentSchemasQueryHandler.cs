...
public class FilterEquipmentSchemasQueryHandler : IQueryHandler<FilterEquipmentSchemasQuery, EquipmentSchema>
{
    public Task<IAsyncEnumerable<EquipmentSchema>> Handle(EntityQuery<FilterEquipmentSchemasQuery, IAsyncEnumerable<EquipmentSchema>> request, CancellationToken cancellationToken)
    {
