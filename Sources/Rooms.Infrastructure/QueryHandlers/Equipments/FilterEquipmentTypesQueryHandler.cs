...
{
    public Task<IAsyncEnumerable<EquipmentType>> Handle(EntityQuery<FilterEquipmentTypesQuery, IAsyncEnumerable<EquipmentType>> request, CancellationToken cancellationToken)
    {
