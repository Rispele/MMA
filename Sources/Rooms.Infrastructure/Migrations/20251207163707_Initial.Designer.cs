...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rooms.Domain.Models.Equipments.EquipmentSchema", b =>
                {
                    ...
                    b.Property<IReadOnlyDictionary<string, string>>("ParameterValues")
                        .IsRequired()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Rooms.Domain.Models.Equipments.Equipment", b =>
                {
                    b.HasOne("Rooms.Domain.Models.Rooms.Room", null)
                        .WithMany("Equipments")
            ...
            modelBuilder.Entity("Rooms.Domain.Models.Rooms.Room", b =>
                {
                    ...
                    b.OwnsOne("Rooms.Domain.Models.Rooms.Fix.RoomFixInfo", "FixInfo", b1 =>
                        {
                    ...
                    b.OwnsOne("Rooms.Domain.Models.Rooms.Parameters.RoomParameters", "Parameters", b1 =>
                        {
                            b1.Property<int>("RoomId")
                                .HasColumnType("integer")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Rooms.Domain.Models.Rooms.RoomScheduleAddress", "ScheduleAddress", b1 =>
                        {
                            b1.Property<int>("RoomId")
                                .HasColumnType("integer")
                                .HasColumnName("id");
