...
public class EquipmentEntityTypeConfiguration : IEntityTypeConfiguration<Domain.Models.EquipmentModels.Equipment>
{
    public void Configure(EntityTypeBuilder<Domain.Models.EquipmentModels.Equipment> builder)
    {
